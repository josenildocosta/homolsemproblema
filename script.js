...
const dataInicio = new Date("2023-05-11T17:38:21.817Z");
...
function atualizarContador() {
  ...
  contador.textContent = `${horas.toString().padStart(2, '0')}h ${minutos.toString().padStart(2, '0')}min ${segundos.toString().padStart(2, '0')}s`;
